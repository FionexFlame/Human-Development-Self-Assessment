...
export default function AssessmentForm() {
  ...
  async function handleSubmit() {
    ...
    try {
      if (!isAdultConfirmed) {
        throw new Error("You must confirm that you are 18 years of age or older to use this assessment.");
      }
      ...
      <div className="card">
        ...
        <div className="grid" style={{ gap: 12, marginTop: 16 }}>
          ...
          <p className="small" style={{ marginLeft: 26, marginTop: -4, color: "#64748b" }}>
            This assessment is intended only for adults age 18 and older. If you are under 18, do not continue.
          </p>
          ...
          <p className="small">
            By submitting, you agree to the <a href="/privacy">Privacy Notice</a> and{" "}
